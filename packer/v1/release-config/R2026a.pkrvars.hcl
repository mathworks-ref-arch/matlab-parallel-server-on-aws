...
// Use this Packer configuration file to build AMI with R2026a MATLAB Parallel Server and related toolboxes installed.
// For more information on these variables, see /packer/v1/build-parallel-server-ami.pkr.hcl.
RELEASE         = "R2026a"
BASE_AMI_NAME   = "ubuntu/images/hvm-ssd-gp3/ubuntu-noble-24.04-amd64-server-*"
STARTUP_SCRIPTS = [".env", "setup-mjs-hostname.sh", "10_setup-disks.sh", "15_setup-shared-storage.sh", "20_optimize-gpu.sh", "30_setup-logging.sh", "35_setup-machine.sh", "40_setup-matlab.sh", "50_warmup-matlab.sh", "55_prepare_snapshot_data.sh", "60_edit-mjs-def.sh", "70_sync-mjs-files.sh", "80_start-mjs.sh", "90_add-spot-instance-monitoring.sh", "95_setup-clustermanagement-program.sh"]
RUNTIME_SCRIPTS = ["cluster_management", "mwplatforminterfaces", "spotinstances", "nfs-share"]
...
NVIDIA_CUDA_TOOLKIT     = "https://developer.download.nvidia.com/compute/cuda/12.8.0/local_installers/cuda_12.8.0_570.86.10_linux.run"
